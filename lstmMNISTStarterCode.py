...
random.seed(3)
result_dir = './resultsLSTM/'  # directory where the results from the training are saved
...
fname = 'accLSTM/Train_Accuracy.png'
pylab.savefig(fname)
plt.clf()
pl1 = plt.scatter(stepAcc, testAcc)
fname = 'accLSTM/Test_Accuracy.png'
pylab.savefig(fname)
plt.clf()
pl1 = plt.scatter(stepAcc, lossTrack)
fname = 'accLSTM/cross_entropy.png'
pylab.savefig(fname)
plt.clf()
